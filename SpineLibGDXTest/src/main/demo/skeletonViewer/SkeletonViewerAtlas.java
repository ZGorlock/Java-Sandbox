...
class SkeletonViewerAtlas extends TextureAtlas {
    ...
    private @Null FileHandle findAtlasFile(FileHandle skeletonFile) {
        ...
        for (String startSuffix : SkeletonViewer.startSuffixes) {
            for (String endSuffix : SkeletonViewer.endSuffixes) {
                for (String dataSuffix : SkeletonViewer.dataSuffixes) {
    ...
    private @Null FileHandle findAtlasFile(FileHandle skeletonFile, String baseName) {
        for (String startSuffix : SkeletonViewer.startSuffixes) {
            for (String endSuffix : SkeletonViewer.endSuffixes) {
                for (String suffix : SkeletonViewer.atlasSuffixes) {
