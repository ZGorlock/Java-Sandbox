...
public class RawComponentMathHandler implements ComponentMathHandlerInterface<Number> {
     ...
     */
    public static final Number PRECISION = ComponentMathHandlerInterface.DEFAULT_PRECISION;
    
    /**
     * The number of significant figures of the precision.
     */
    public static final int SIGNIFICANT_FIGURES = ComponentMathHandlerInterface.DEFAULT_SIGNIFICANT_FIGURES;
